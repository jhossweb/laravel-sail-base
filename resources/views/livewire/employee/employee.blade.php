<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-8 my-8">
    <div class="bg-white shadow-xl sm:rounded-lg p-4">
        ...
        <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
            <div>
                <x-button wire:click="openModal" class="mr-2">Nuevo</x-button>
            ...
            <div class="relative">
                ...
                <x-input wire:model.live="search" type="text" id="table-search" class="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500  dark:border-gray-600 dark:placeholder-gray-400 text-gray-900 dark:focus:ring-blue-500 dark:focus:border-blue-500 " placeholder="Buscar Empleados" />
